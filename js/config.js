...
var l_serverImage = "logotip.png";

/*Custom server name configuration
Leave it blank for automatic server name*/
var l_serverName = "Mass Effect: Invasion";
...
var l_musicPlaylist = [
	{ogg: "songs/masseffect.ogg", name: "Mass Effect - Invasion"}
];
...
var l_messages = [
"Готовимся к вылету.",
"Устанавливаем барикады.",
"За Альянс!",
"Собираем Иридий.",
"Осуществляем защиту контента!",
"Сражаемся с жнецами."
];
